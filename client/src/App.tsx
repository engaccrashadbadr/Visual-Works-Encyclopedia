...
import MarvelTimelinePage from "./pages/MarvelTimelinePage";
import NotFound from "./pages/NotFound";

function Router() { return <Switch><Route path="/" component={Home}/><Route path="/search" component={SearchPage}/><Route path="/work/:id" component={WorkPage}/><Route path="/assistant" component={AssistantPage}/><Route path="/entity/:id" component={EntityPage}/><Route path="/compare" component={ComparePage}/><Route path="/settings" component={SettingsPage}/><Route path="/admin" component={AdminPage}/><Route path="/map" component={UniverseMapPage}/><Route path="/timeline" component={MarvelTimelinePage}/><Route path="/404" component={NotFound}/><Route component={NotFound}/></Switch>; }
